            ...
            <div style={{ display: walletInfo.address ? 'inline' : 'none' }}  >
              <div className="circle_pic" >
                <span className="balance_info">
                  <span className="nft_pic_title" >{convertMicroDenomToDenom(flixBalance?.amount).toFixed(1)}</span>
                  <span className="nft_pic_title" style={{ fontSize: "20px" }}>{config.COIN_DENOM}</span>
                </span>
                <img src="./img/blkh.png" />
              </div>
            </div>
            <div style={{ display: walletInfo.address ? 'inline' : 'none' }}  >
              <div className="circle_pic" >
                <span className="balance_info">
                  <span className="nft_pic_title" >{convertMicroDenomToDenom(holeBalance?.amount).toFixed(1)}</span>
                  <span className="nft_pic_title" style={{ fontSize: "20px" }}>{"HOLE"}</span>
                </span>
                <img src="./img/blkh.png" />
              </div>
            </div>
