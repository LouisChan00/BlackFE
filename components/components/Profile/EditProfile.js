            ...
            <div name="contactForm" id='contact_form' className="form-border">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="field-set">
                    <label>Discord</label>
                    <input type='text' name='user_discord' id='discord' className="form-control" value={user.user_discord || ''} onChange={handleChange} autoComplete="off" />
                  </div>
                </div>
                ...
                <div className="col-md-6">
                  <div className="field-set">
                    ...
                    <input type='text' name='user_tg' id='tg' className="form-control" value={user.user_tg || ''} onChange={handleChange} autoComplete="off" />
                  </div>
                </div>
