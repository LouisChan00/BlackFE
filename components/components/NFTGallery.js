...
import { getShortAddress } from "../../utils/conversion";
            ...
            <div className="row">
              <div className="col-md-12 position-relative">
                ...
                <div className="artist_info">
                  ...
                  <h4 className="artist_address" onClick={(e) => handleCopy(e, selectedUser.address)}>
                    <span className={copied ? 'blur' : ''}>{selectedUser.address}</span>
                    <ContentCopyIcon />
                    {copied && (
              ...
              <div className="col-md-8">
                <div className="row mt-4">
                  ...
                  <div className="col-md-8 text-label">
                    <span className="text-desc">{selectedUser.discord}</span>
                  </div>
                  <div className="col-md-4 text-label">
                    <span>Telegram:</span>
                  </div>
                  <div className="col-md-8 text-label">
                    <span className="text-desc">{selectedUser.telegram}</span>
                  </div>
                  <div className="col-md-4 text-label">
